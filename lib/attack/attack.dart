              ...
              children: <Widget>[
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: 'An "Attack X" ability allows a character to do a base X amount of damage to an enemy within their range. Figures cannot attack their allies. There' +
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: 'Ranged attacks are accompanied by a "Range Y" value, which means any enemy within Y hexes can be ' +
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: 'Melee attacks have no accompanying' +
                    ...
                    Flexible(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text: 'An attacker\'s attack modifiers are applied first. These modifiers include bonuses and penalties from active ability cards, items, and ' +
                    ...
                    Flexible(
                      child: RichText(
                        text: TextSpan(
                          ...
                          children: [
                            TextSpan(
                                text: 'Lastly, the defender\'s defensive bonuses are applied. This reduces the incoming attack value for each individual enemy targeted based on each defender\'s ' +
                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      TextSpan(
                          text: 'Example: The Scoundrel performs an "Attack 3" ability on an adjacent elite Bandit Guard. The Scoundrel' +
