                ...
                RichText(
                  text: TextSpan(
                    ...
                    children: [
                      ...
                      TextSpan(
                          text:
                              ' in the lower left corner and 10 cards with an '),
                      WidgetSpan(
                      ...
                      TextSpan(
                          text:
                              ' cards can only be placed in the monster attacker deck (when a monster is cursed), and '),
                      WidgetSpan(
                        child: ReferenceLetterImage("character_curse_card"),
                      ),
                      TextSpan(
                          text: ' cards can only be placed in a character\'s attack deck (when a character or character summon is cursed). Thus, a maximum ' +
